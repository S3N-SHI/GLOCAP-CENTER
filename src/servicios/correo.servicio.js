...
export async function enviarCodigoVerificacion(correoDestino, nombre, codigo) {
  ...
  if (error) {
    ...
    // (por ejemplo, por restricciones del dominio de prueba) — devuelve
    // el error acá adentro. Si no revisamos esto a mano, el error queda
    // invisible y el registro "funciona" aunque el correo nunca salga.
